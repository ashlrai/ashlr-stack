...
export const PROVIDERS: Provider[] = [
  ...
  },
  {
    ...
    category: "Database",
    color: "EE2A6C",
    blurb: "Reactive backend-as-a-service",
    auth: "API key",
    keyOnly: true,
  },
  {
  ...
  // Errors (1)
  {
    ...
    category: "Errors",
    color: "362D59",
    blurb: "Error + performance tracking",
    mcp: true,
    auth: "PAT",
  },
  ...
  // Email (4)
  {
    ...
    category: "Email",
    color: "FFFFFF",
    blurb: "Transactional + React email",
    auth: "API key",
    keyOnly: true,
  },
  {
    ...
    category: "Email",
    color: "1A82E2",
    blurb: "High-volume transactional mail",
    auth: "API key",
    keyOnly: true,
  },
  {
  ...
  },
  {
    ...
    category: "Email",
    color: "FFDE00",
    blurb: "Deliverability-focused transactional",
    auth: "API key",
    keyOnly: true,
  },
